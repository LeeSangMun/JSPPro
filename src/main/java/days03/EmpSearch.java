...
public class EmpSearch extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
       ...
       //두번째. job 정보를 가져와서 jlist에 담아서 arrayslist넘기기
       ...
       //3. 전체사원 정보 조회 days02.ex01.jsp
     //http://localhost/jspPro/days03/empsearch.htm?deptno=20
       ...
       try {
		...
		System.out.println("> EMPSEARCH.java doGET() 3. 사원 정보조회.");
		e.printStackTrace();
	}//catch
