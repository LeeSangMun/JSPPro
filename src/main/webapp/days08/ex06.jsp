...
try {
	...
	EmpVO dto = new EmpVO(rs.getInt("empno"), rs.getString("ename"), rs.getString("job"), rs.getInt("mgr"),
			rs.getDate("hiredate").toString(), rs.getDouble("sal"), rs.getDouble("comm"), rs.getInt("deptno"));
	empList.add(dto);
		} while (rs.next());
	} // if
